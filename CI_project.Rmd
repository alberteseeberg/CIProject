...
pirateplot(formula = RawPercent ~ Condition + DeviantLevel + Deviant, data = CIDataPlot, main = "Results", xlab = "group",ylab="% Correct", ylim= c(45,85), theme=2, pal="info", avg.line.o=0.8, bar.f.o = .2, bean.b.o = .7, point.o = 0.3, point.pch = 1, back.col = "white") +
  abline(a=0.3,0.3, b=0, lwd=2, lty="dashed")




ggplot(data=CIData, aes(x=DeviantLevel, y=RawPercent))+geom_violin()+facet_wrap("Deviant")
...
CIDataPlot=aggregate(CIData$Correct,list(CIData$DeviantLevel, CIData$Deviant, CIData$ID), mean)
...
pirateplot(formula = AvCor ~ Condition + DeviantLevel + Deviant, data = CIDataPlot, main = "", xlab = "group",ylab="Averaged % Correct", ylim= c(0,100), theme=2, pal="info", cex.lab = 0.7, cex.axis = 1, cex.names = 0.7, avg.line.o=0.8, bar.f.o = .2, bean.b.o = .7, point.o = 0.3, point.pch = 1, back.col = "white") +

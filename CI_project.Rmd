...
## Inspecting best performing models
```{r}
library(ggpubr)

ggdensity(CIData$AarUdenHoerelse, 
          main = "Density plot of years without hearing",
          xlab = "Years without hearing")

shapiro.test(CIData$AarUdenHoerelse)


ggdensity(CIData$Alder, 
          main = "Density plot of age",
          xlab = "Age")

shapiro.test(CIData$Alder)

ggdensity(CIData$RawPercent, 
          main = "Density plot raw percent score",
          xlab = "Raw percent score")

shapiro.test(CIData$RawPercent)
